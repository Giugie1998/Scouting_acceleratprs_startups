...
function setSecret_(chiave, valore) {
...
function getOpenRouterReferer_() {
  return getSecret_(OPENROUTER_HTTP_REFERER);
}

function getOpenRouterTitle_() {
  return getSecret_(OPENROUTER_X_TITLE);
}
...
function setupLLMKey_() {
  ...
  setSecret_(CHIAVE_API_LLM, chiave);
